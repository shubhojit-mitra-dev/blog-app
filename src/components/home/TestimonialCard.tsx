...
export default function TestimonialCard({ quote, name, title }: TestimonialCardProps) {
  return (
    <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
      <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-[#1b1b1b] transform transition duration-500 hover:scale-105 hover:border-2 hover:border-primary text-center">
