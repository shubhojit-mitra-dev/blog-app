...
export default function PricingCard({ 
  ...
  return (
    <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
      <div className={`p-6 bg-white rounded-lg shadow-lg dark:bg-[#111] transform transition duration-500 hover:scale-105 text-center ${isFeatured ? 'border-2 border-purple-500' : ''}`}>
        ...
        <Button 
          className="mx-1 hover:border-2 hover:border-purple-500 cursor-pointer" 
          variant="secondary"
        >
          Choose Plan
        </Button>
